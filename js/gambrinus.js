...
async function main() {
  ...
  const canvas = document.getElementById("#gambrinus");
  ...
  const objHref = "../objs/gambrinus/uploads_files_48654_gambrinus.obj";
  ...
  const matTexts = await Promise.all(
    obj.materialLibs.map(async (filename) => {
      ...
      const response = await fetch(
        "../objs/gambrinus/uploads_files_48654_gambrinus.mtl"
      );
